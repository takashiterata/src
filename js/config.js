  ...
  try{
    ...
    for(let i =0;i<layout.length;i++){
      ...
      if(tabsetval2[0] == '0'){
        ...
        if(layout[i]['type'] == 'SUBTABLE'){
          tabsetvalTop[tabsetval2[1]] += '<div class="" style="">'+gproperties[layout[i]['code']].label+'<br>';
    ...
    for(let i =0;i<layout.length;i++){  //未設定の行
      ...
      if(i >=  tabsetval.length-1){
        ...
        if(layout[i]['type'] == 'SUBTABLE'){
          HtmlInnerVal += '<div class="" style="">'+gproperties[layout[i]['code']].label+'<br>';
          for(let i4=0;i4 <layout[i]['fields'].length;i4++){
      ...
      for(let ii =0;ii<layout.length;ii++){
        ...
        if(tabsetval2[0] == i){
          ...
          if(layout[ii]['type'] == 'SUBTABLE'){
            tabsetvalmid[tabsetval2[1]] += '<div class="" style="">'+gproperties[layout[i]['code']].label+'<br>';
    ...
    for(let i =0;i<layout.length;i++){
      ...
      if(tabsetval2[0] == '999'){
        ...
        if(layout[i]['type'] == 'SUBTABLE'){
          tabsetvalBtm[tabsetval2[1]] += '<div class="" style="">'+gproperties[layout[i]['code']].label+'<br>';
          for(let i4=0;i4 <layout[i]['fields'].length;i4++){
