  ...
  try{
    ...
    for(let i =0;i<layout.length;i++){
      ...
      if(tabsetval2[0] == '0'){
        ...
        if(layout[i]['type'] == 'SUBTABLE'){
          tabsetvalTop[tabsetval2[1]] += '<div class="" style="padding-left:8px;">'+gproperties[layout[i]['code']].label+'<br>';
    ...
    for(let i =0;i<layout.length;i++){  //未設定の行
      ...
      if(i >=  tabsetval.length-1){
        ...
        if(layout[i]['type'] == 'SUBTABLE'){
          HtmlInnerVal += '<div class="" style="padding-left:8px;">'+gproperties[layout[i]['code']].label+'<br>';
          for(let i4=0;i4 <layout[i]['fields'].length;i4++){
      ...
      for(let ii =0;ii<layout.length;ii++){
        ...
        if(tabsetval2[0] == i){
          ...
          if(layout[ii]['type'] == 'SUBTABLE'){
            tabsetvalmid[tabsetval2[1]] += '<div class="" style="padding-left:8px;">'+gproperties[layout[i]['code']].label+'<br>';
    ...
    for(let i =0;i<layout.length;i++){
      ...
      if(tabsetval2[0] == '999'){
        ...
        if(layout[i]['type'] == 'SUBTABLE'){
          tabsetvalBtm[tabsetval2[1]] += '<div class="" style="padding-left:8px;">'+gproperties[layout[i]['code']].label+'<br>';
          for(let i4=0;i4 <layout[i]['fields'].length;i4++){
...
if(valhtml['type']=='SPACER'){  //スペース
  ...
  htmlaa += '<div class="" style="box-sizing: border-box;; height: auto;display:inline-block;padding-left:8px;">';
